...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "odl_dev_vm" do |odl_dev_vm|

    odl_dev_vm.vm.provision :shell, path: "provisioning/setup-odl-dev-vm.sh",
                         privileged: false,
                         args: [
                           vagrant_config['http_https_proxy'],
                           vagrant_config['host_external_net_ip'],
                           ...
                           vagrant_config['gerrit_parameters']['gerrit_private_key_contents']
                         ]
